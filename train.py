...
def create_next_candidates(prev_candidates, length):
    """
    Returns the fuzzy_recommender_model candidates as a list.
    Arguments:
...
# API function.
################################################################################
def fuzzy_recommender_model(transactions, **kwargs):
    """
    Executes fuzzy_recommender_model algorithm and returns a RelationRecord generator.
    Arguments:
        transactions -- A transaction iterable object
                        (eg. [['A', 'B'], ['B', 'C']]).
    Keyword arguments:
